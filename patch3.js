...
const targetStr = `            document.getElementById('answerKeySourceContainer').classList.add('hidden');
        }

        await renderPreview(config.startPage, firstPageCanvas, firstCtx);`;

const replacement = `            document.getElementById('answerKeySourceContainer').classList.add('hidden');
        }
